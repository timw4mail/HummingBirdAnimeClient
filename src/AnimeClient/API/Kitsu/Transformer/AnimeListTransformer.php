	...
	public function transform(array|object $item): AnimeListItem
	{
		...
		return AnimeListItem::from([
			...
			'anime' => [
				...
				'age_rating_guide' => $anime['ageRatingGuide'] ?? null,
				'title' => $title,
				'titles' => $titles,
				'titles_more' => Kitsu::filterLocalizedTitles($anime['titles']),
				'slug' => $anime['slug'],
				...
				'episode_length' => $anime['episodeLength'],
				'status' => Kitsu::getAiringStatus($anime['startDate'], $anime['endDate'])->value,
				'synopsis' => $anime['description']['en'] ?? '',
				'trailer_id' => $anime['youtubeTrailerVideoId'] ?? null,
				'total_length' => $anime['totalLength'] ?? null,
				'url' => 'https://kitsu.app/anime/' . $anime['slug'],
			],
