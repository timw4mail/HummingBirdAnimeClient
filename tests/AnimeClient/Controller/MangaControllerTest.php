...
class MangaMockKitsuModel extends \Aviat\AnimeClient\API\Kitsu\Model
{
...
class MockMangaController extends MangaController
{
...
final class MangaControllerTest extends AnimeClientTestCase
{
	protected function setUp(): void
	{
		...
		$model = new MangaMockKitsuModel($this->container);
	...
	{
		$model = $this->createMock(\Aviat\AnimeClient\Model\Manga::class);
		$model->method('getManga')->willReturn(\Aviat\AnimeClient\Types\MangaPage::from([]));
		$this->container->setInstance('manga-model', $model);

		$controller = new MockMangaController($this->container);
	...
	public function testIndexInvalidView(): void
	{
		...
		ob_start();
		$controller->index('reading', 'invalid');
		ob_end_clean();
